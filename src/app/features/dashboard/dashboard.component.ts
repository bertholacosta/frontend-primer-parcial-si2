        ...
        <div class="bg-white overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:rounded-2xl border border-gray-100">
          ...
          <div class="px-4 py-8 sm:px-10 bg-white">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <!-- Card 1 -->
              <div class="bg-white border-2 border-dashed border-gray-200 rounded-xl p-6 hover:border-blue-400 hover:bg-blue-50 transition-colors cursor-pointer group">
